...
DEBUG_BookshelfTask:
    type: task
    script:
    - define bookshelfgui <proc[DEBUG_BookshelfClone]>
    - inventory open d:<[bookshelfgui]> player:<player[EchosBattalion]>
    - inventory open d:<[bookshelfgui]> player:<player[ZyadTheBoss]>